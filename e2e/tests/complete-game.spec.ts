...
test.describe('Complete Game Flow', () => {
  ...
  test('should handle mid-game score review correctly', async ({ page }) => {
    ...
    // Check the round 1 delta for player 0 (Alice)
    await expect(page.getByTestId('round-1-delta-player0')).toBeVisible({ timeout: 10000 }); // Both players made their 0 bids: (0×10)+10 = +10 each
  });
